...
class HuginParser;
  class ErrorHandler {
    ...
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, JAVACC_STRING_TYPE expectedToken, Token *actual, HuginParser *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, JAVACC_SIMPLE_STRING production, HuginParser *parser) {
        error_count++;
...
#endif
/* JavaCC - OriginalChecksum=30eed25e3f9a1a82831a12e49fdaef16 (do not edit this line) */
